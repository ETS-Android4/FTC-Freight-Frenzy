 ...
 */
@Config
public class SampleMecanumDriveCancellable extends MecanumDrive {
    ...
    public SampleMecanumDriveCancellable(HardwareMap hardwareMap) {
    ...
    public void cancelFollowing() {
        trajectorySequenceRunner.cancelTrajectorySequence();
        mode = Mode.IDLE;
    }
