...
public class RedAltSmallParkAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (result == BarcodePosition.LEFT) {
            t1 = drive.trajectorySequenceBuilder(p1)
                    ...
                    .build();
            p2 = new Pose2d(9, -26.5, Math.toRadians(90));
        } else if (result == BarcodePosition.CENTER) {
            t1 = drive.trajectorySequenceBuilder(p1)
                    .addTemporalMarker(() ->
                            slideDrive.setPower(0.5)
                    )
                    .lineTo(new Vector2d(12.5, -26.5))
                    .build();
            p2 = new Pose2d(12.5, -26.5, Math.toRadians(90));
        } else {
            t1 = drive.trajectorySequenceBuilder(p1)
                    .addTemporalMarker(() ->
                            slideDrive.setPower(0.5)
