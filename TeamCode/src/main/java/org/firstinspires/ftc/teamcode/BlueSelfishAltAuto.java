...
public class BlueSelfishAltAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (result == BarcodePosition.LEFT) {
            t1 = drive.trajectorySequenceBuilder(p1)
                    ...
                    .lineToLinearHeading(new Pose2d(-9, 40.5, Math.toRadians(180)))
                    .build();
            p2 = new Pose2d(-9, 40.5, Math.toRadians(180));
        ...
        TrajectorySequence t3 = drive.trajectorySequenceBuilder(p3)
                ...
                .splineTo(new Vector2d(-13, 38), Math.toRadians(180))
                .addTemporalMarker(() ->
                        pivotServo.setPosition(0.07)
                )
